...
export default function Hero() {
  return (
    <div className={`h-screen max-lg:h-3/4 w-full bg-[url('/group_photo.jpeg')] bg-cover bg-no-repeat bg-center`}>
        <div className="h-full px-8 max-sm:px-4 py-14 max-lg:pt-40 bg-[rgba(31,31,31,0.8)] flex flex-col justify-center items-center text-center">
