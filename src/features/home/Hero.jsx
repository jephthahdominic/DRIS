...
export default function Hero() {
  return (
    <div className={`h-screen max-xl:h-3/4 w-full bg-[url('/group_photo.jpeg')] bg-cover bg-no-repeat bg-center`}>
        <div className="h-full p-8 max-md:pt-20 bg-[rgba(31,31,31,0.8)] flex flex-col justify-center items-center text-center">
            <h1 className="text-5xl text-[#FFF] font-semibold max-md:leading-normal">Nurturing Leaders of Tomorrow</h1>
