...
export default function Hero() {
  return (
    <div className={`h-screen max-xl:h-3/4 w-full bg-[url('/group_photo.jpeg')] bg-cover bg-no-repeat bg-center`}>
        <div className="h-full px-8 max-sm:px-4 py-14 max-md:pt-40 bg-[rgba(31,31,31,0.8)] flex flex-col justify-center items-center text-center">
            ...
            <Link to="/about_us" className="text-[#1D4ED8] bg-white border border-blue-500 hover:bg-[#1D4ED8] hover:text-[#fff] text-[1.1rem] transition-all shadow-2xl p-3 px-8 mt-10 rounded-[10px]">Discover more</Link>
        </div>
    </div>
  )
}
