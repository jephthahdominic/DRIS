  ...
  return (
    <div className="cursor-pointer h-max bg-[#f5f5f5] shadow-md rounded-md border border-gray-200" onClick={()=>clickAction()}>
      <div className="relative h-[300px]">
        ...
        {item.fields.isVideo && <IoPlay className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 rounded-full bg-white p-2 text-red-500 text-5xl" />}
      </div>
