  ...
  return (
    <div className="min-h-screen max-lg:h-3/4 w-full">
      <div className="h-3/4 px-8 max-sm:px-4 py-14 pt-40 bg-[rgba(31,31,31,0.8)] flex flex-col justify-center items-center text-center">
        <h1 className="text-5xl max-sm:text-4xl text-[#FFF] font-semibold max-md:leading-normal">Keep in Touch</h1>
      ...
      <section className="py-14 flex max-lg:flex-col justify-center items-center gap-52 max-lg:gap-24 xl:bg-[#f5f5f5]">
        ...
        <div className="flex flex-col xl:w-[40%] max-sm:w-[100%] max-sm:p-10 sm:w-[70%] lg:items-center max-sm:bg-[#f5f5f5]">
      ...
      <section className="px-8 max-sm:px-4 py-10 text-center flex flex-col items-center gap-4 bg-white w-full">
